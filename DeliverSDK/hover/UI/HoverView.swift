...
// MARK: - HoverView
internal class HoverView: UIView {
    ...
    internal var onPositionChange: ((HoverPosition) -> ())?
    ...
    // MARK: Lifecycle
    internal init(with configuration: HoverConfiguration = HoverConfiguration(), items: [HoverItem] = []) {
